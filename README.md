...
Este repositório foi criado para a **Avaliação A1** da disciplina de Técnicas de Desenvolvimento de Algoritmos. O projeto demonstra o domínio das estruturas fundamentais de programação em **Python**, seguindo os requisitos de clareza, organização e versionamento com Git.

Os arquivos estão organizados por tópico, facilitando a navegação e a avaliação de cada uma das atividades propostas.

---

## 📂 Conteúdo e Organização do Repositório

O projeto está dividido em pastas temáticas que correspondem aos principais conceitos avaliados:
